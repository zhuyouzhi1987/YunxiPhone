...
public class NewsKindAdapter extends BaseAdapter {
    ...
    public NewsKindAdapter(Context context) {
        ...
        if (currentType == TYPE_SMALL) {
            ...
            if (convertView == null) {
                ...
                smallView = LayoutInflater.from(context).inflate(
                        R.layout.news_kind_item_small, null);
            ...
            if(convertView==null){
                ...
                thirdView=LayoutInflater.from(context).inflate(R.layout.news_kind_item_third,null);
