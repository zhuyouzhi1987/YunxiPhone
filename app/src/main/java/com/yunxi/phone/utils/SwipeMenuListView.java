...
import com.yunxi.phone.adapter.SwipeMenuAdapter;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                mTouchPosition = pointToPosition((int) ev.getX(), (int) ev.getY());
                myPosition = pointToPosition((int) ev.getX(), (int) ev.getY());
                ...
                if (mTouchState == TOUCH_STATE_X) {
                    if (mTouchView != null) {
                        ...
                        if (isBeforeOpen != isAfterOpen && mOnMenuStateChangeListener != null) {
                            if (isAfterOpen) {
                                mOnMenuStateChangeListener.onMenuOpen(myPosition);
                            } else {
                                mOnMenuStateChangeListener.onMenuClose(myPosition);
                            }
                        }
                        if (!isAfterOpen) {
                            mTouchPosition = -1;
