...
public class CarouselViewForBanner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public CarouselViewForBanner(Context context) {
        super(context);
        this.context = context;
    }

    public CarouselViewForBanner(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public CarouselViewForBanner(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mTimer.schedule(mTimerTask, 3000, 3000);
    ...
    protected void onFinishInflate() {
        ...
        pageItemWidth = UserInfoUtil.dip2px(context,18);
        pageItemHeight=UserInfoUtil.dip2px(context,3);
    ...
    public void onPageSelected(int position) {
        ...
        for (int i = 0;i<count;i++){
            ...
            if(position%showCount==i){
                ...
                LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(pageItemWidth,pageItemHeight );
                params.setMargins(5, 0, 5, 0);
                view.setLayoutParams(params);
            }else {
