...
//		Drawable blue = getResources().getDrawable(R.drawable.pl_blue);
		...
		Drawable d1=getResources().getDrawable(R.drawable.egg1);
		Drawable d2=getResources().getDrawable(R.drawable.egg2);
		Drawable d3=getResources().getDrawable(R.drawable.egg3);
		Drawable d4=getResources().getDrawable(R.drawable.egg4);
		Drawable d5=getResources().getDrawable(R.drawable.egg5);
		Drawable d6=getResources().getDrawable(R.drawable.egg6);
		Drawable d7=getResources().getDrawable(R.drawable.egg7);
		Drawable d8=getResources().getDrawable(R.drawable.egg8);
		Drawable d9=getResources().getDrawable(R.drawable.egg9);
		Drawable d10=getResources().getDrawable(R.drawable.egg10);
		Drawable d11=getResources().getDrawable(R.drawable.egg11);
		Drawable d12=getResources().getDrawable(R.drawable.egg12);
		Drawable d13=getResources().getDrawable(R.drawable.egg13);
...
//		dWidth = red.getIntrinsicWidth();
	...
	public void addHeart() {
		...
		// 随机选一个
		imageView.setImageDrawable(drawables[random.nextInt(13)]);
